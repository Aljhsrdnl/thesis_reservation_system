...
export const register = ({ name, email, password, identification_num, user_type }) => dispatch => {
    ...
    //request body
    const body = JSON.stringify({ name, email, password, identification_num, user_type });
